...
import {RegisterInfo} from "./components/forms/messages/RegisterInfo";
import {PrivateRoute} from "./commonActions/PrivateRoute";
import {LoginViaGoogleActivation} from "./components/main/LoginViaGoogleActivation";
import {BookingInfo} from "./components/forms/messages/BookingInfo";
...
import {ManageEmployees} from "./components/partner/settings/employees/ManageEmployees";
import {UpdateEmployeeById} from "./components/partner/settings/employees/UpdateEmployeeById";
import {AddNewEmployee} from "./components/partner/settings/employees/AddNewEmployee";
import {PartnerSlots} from "./components/partner/settings/slots/PartnerSlots";
import {UpdateSlot} from "./components/partner/settings/slots/UpdateSlot";
            ...
            <Router>
                ...
                <div className='content'>
                    <Switch>
                        ...
                        <PrivateRoute exact path={'edit-slot/:id'} component={UpdateSlot}/>
                        <PrivateRoute exact path={'/partner-profile'} component={PartnerProfile}/>
                        <PrivateRoute exact path={'/add-employee'} component={AddNewEmployee}/>
                    </Switch>
                </div>
