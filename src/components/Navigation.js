...
function Navigation() {
    ...
    return (
            <Navbar bg="light" expand="lg" className="flex-row flex-grow pb-4 md:pb-0
                    md:flex md:justify-end md:flex-row float-left w-full
                    divide-y-2 divide-gray-500 divide-y-reverse pr-3 pt-16">
                ...
                <Navbar.Collapse className="-mb-px flex float-left">
                    <ButtonGroup
                        ...
                        <Button
                            variant='secondary'
                            className='button-hover px-4 py-1 mt-2 mb-2 hover:text-gray-900 focus:text-gray-900
